...
<style lang="scss">
	.cat-label{
		...
		.container{
			...
			.text{color: #7C89A4;width: 25%;margin-right:5%; font-size: $uni-font-size-base;text-overflow: ellipsis;white-space: nowrap;color: inherit;line-height: 1.5;overflow: hidden;}
			.hasX::before{
				content: "*";
				color: red;
			}
