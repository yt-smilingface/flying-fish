	 ...
	 class="uni-list-item" @click="onClick">
		<view class="uni-list-item__container" :class="{'uni-list-item--first':isFirstChild}">
			...
			<view v-if="showText || showBadge || showArrow || showSwitch" class="uni-list-item__extra">
				<text v-if="showText" class="showText" :class="{showTextActive: showActive}">{{showTxt}}</text>
				<uni-badge v-if="showBadge" :type="badgeType" :text="badgeText" />
				<switch v-if="showSwitch" :disabled="disabled" :checked="switchChecked" @change="onSwitchChange" />
				<uni-icons v-if="showArrow" :size="16" class="uni-icon-wrapper" color="#ddd" type="arrowright" />
			</view>
		</view>
	</view>
	<!-- #ifdef APP-NVUE -->
